        ...
        if ($count == 1) {
            ...
            if ($failcount < $failmax) {
                ...
                if (password_verify($_POST['password'], $res['password'])) {
                    ...
                    //Insert Login Timestamp into DB table login_log
                    ...
                    $errors[] = "You have {$remainingattempts} login attempts remaining, otherwise you will be blocked for 5 minutes";
                }
            } else {
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <?php
                        if (!empty($errors)) {
                            echo "<div class='alert alert-icon-left alert-danger mb-4' role='alert'>";
