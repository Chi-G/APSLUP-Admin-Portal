...
$url = "https://localhost/admin-portal/";
...
if (isset($_POST) & !empty($_POST)) {
    ...
    if (empty($errors)) {
        ...
        $userid = $res['id'];
        if ($count == 1) {
            $messages[] = 'Username / Email Exists in database, create reset token and send email';
             ...
             try {
                 ...
                 $mail->addAddress('chijindu.nwokeohuru@gmail.com', 'Chijindu Nwokeohuru');     // Add a recipient
            ...
            $errors[] = 'Your account is not available in our activated accounts, please check with the site Admin!';
        }
    }
}
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="d-sm-flex justify-content-between">
                                            <div class="field-wrapper">
                                                <button type="submit" class="btn btn-warning" value="">Reset Password</button>
                                            </div>                                    
                                        </div>
                                    </div>
                                </fieldset>
